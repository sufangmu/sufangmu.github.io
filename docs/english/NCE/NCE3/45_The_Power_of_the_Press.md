...
<audio class="nce-audio" preload="metadata" src="https://raw.githubusercontent.com/sufangmu/NCE/refs/heads/main/NCE3/45ThePowerofthePress.mp3"></audio>

### Words

- democratic /ˌdɛməˈkrætɪk/ 民主的
- restrict /riˈstrɪkt/ 限制
- abused /əˈbjuzd/ 滥用
- contention /kənˈtɛnʃən/ 论点
- untold /ənˈtold/ 无限的
...
- contention that+句子 ……的论点
- untold harm/pain/damage 数不清的危害/痛苦/损失
- live/work/remain in obscurity 默默无闻地生活/工作
- exclusive access/right/use 独家的接触/权利/使用
- nursery school/teacher/education 幼儿园/幼儿教师/幼儿教育
- it is extremely doubtful whether… ……非常值得怀疑
- act on… 按照……行事
- pour in 涌来
- press for 敦促；争取
- act as 充当
