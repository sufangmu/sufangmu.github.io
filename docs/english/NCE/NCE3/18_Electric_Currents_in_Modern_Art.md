...
- repelled /rəˈpɛld/ 排斥
- flickered /ˈflɪkɚd/ 闪烁
- emitted /ɪˈmɪtəd/ 发散
- equipment /ɪˈkwɪpmənt/ 设备
- peculiar /pəˈkjuljɚ/ 奇怪的
- shock /ʃɑk/ 电击
- emotionally /ɪˈmoʃnəli/ 感情上

### Expressions

- make a sculpture / create a sculpture 创作一件雕塑
- be mistaken about sth./sb. 对某事/某人弄错
- Oddly enough, ...句子  说来也奇怪
- be attached to sb./sth. = attach a. to b. 依附于；把 A 系在 B 上
- get an electric shock 触电
- receive an electric shock 受到电击
- give you electric shocks 电你
- not any more = not any longer = no longer 不再
- The idea that+句子 is mistaken. ……的想法是错误的
- take no interest in 对……不感兴趣
- in response to 作为对……的回应
- be familiar to sb. 为某人所熟悉
- go mad 发疯
- on and o 断断续续地
- It was rather like ... 这颇像……
- seemed designed ... 似乎是为……而设计
